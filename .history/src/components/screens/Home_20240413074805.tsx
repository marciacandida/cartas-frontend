...
const Home = () => {
  return (
    <section className="flex items-center justify-center p-10  ">
      <div className="grid grid-cols-3 border border-pink-800 p-2">
        <Card className="w-[300px] bg-pink-800">
          ...
          <CardContent className="text-white space-y-2">
            ...
            <p className="text-sm bg-white text-pink-800">Software developer</p>
          ...
          <CardFooter className="w-full flex items-center justify-center">
            <Button
              variant={"default"}
              className="w-[80%] bg-white text-pink-800 hover:text-white"
            >
              Ver perfil
            </Button>
          </CardFooter>
