        ...
        <div className="flex rounded-lg bg-gray-100 p-10 w-main space-x-16 relative">
          <section className="w-[500px] relative">
            ...
            <div>
              <div className="flex items-center space-x-2 mt-10">
                <p className="text-paragraph uppercase text-[10px] font-semibold  ">
                  Qualificações
                </p>
              ...
              <div className="space-y-1 mt-5 relative">
                {skills.map((skills) => (
                  <p key={skills.id} className="text-sm  font-semibold">
                    {skills.name}
                  </p>
                ))}
              </div>
          ...
          <section>
            <div className="flex space-x-4 items-center ">
              <h1 className="font-semibold text-2xl">Kelvin Celso</h1>
            ...
            <p className="font-bold text-sm text-pink-800 mt-1">
              Software Developer
            </p>
            <p className="text-paragraph text-sm font-normal mt-7 w-[90%]">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum
              illo id quod. Explicabo necessitatibus porro dolore odit!
              Laboriosam architecto minima, impedit deserunt dolores cumque quas
            ...
            {pathname !== "/profile/consultant/user" && (
              <Link
                href={"/chat"}
                className=" text-white text-sm font-medium transition-all bg-pink-800 px-5 py-2 rounded-lg absolute right-7 top-52 hover:bg-pink-900"
              >
                Enviar mensagem
              </Link>
            )}
