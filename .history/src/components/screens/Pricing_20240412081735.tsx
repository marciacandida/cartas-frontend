...
export default function PricingPage() {
  ...
  const bannerText = "something something";
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          ...
          {bannerText ? (
            <div className="w-full lg:w-auto flex justify-center my-4">
              <p className="w-full px-4 py-3 text-xs bg-pink-800 text-black dark:bg-fuchsia-300/30 dark:text-white/80 rounded-xl">
                {bannerText}
              </p>
            </div>
          ) : null}
                  ...
                  <Label
                    className={cn(
                      frequency.value === option.value
                        ? "bg-pink-800 text-white dark:bg-pink-800 dark:text-white/70"
