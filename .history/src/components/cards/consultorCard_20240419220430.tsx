  ...
  return (
    <Card className="w-[300px]">
      <CardHeader className="p-0 h-48 items-center flex justify-center relative">
        <div className="absolute top-0 left-0 right-0 bottom-[90px] rounded-t-lg bg-pink-800 z-0"></div>
        <img
      ...
      <CardContent className=" space-y-2 px-2 text-center">
        ...
        <p className="text-sm  py-1 px-1 text-pink-800">Software developer</p>
      ...
      <CardFooter className="w-full flex items-center justify-center">
        <Link
          href={"/profile"}
          className=" bg-white text-pink-800 hover:text-white transition-all hover:bg-pink-800 px-10 py-2 rounded-lg"
        >
          Ver perfil
        </Link>
      </CardFooter>
