...
export function Sidebar({ className }: ISidbar) {
  ...
  return (
    <div
      className={cn(
        "fixed top-0 bottom-0 left-0 z-0 pb-12 w-64 border-r border-r-pink-800  bg-white"
      )}
    >
      <div className="space-y-4 py-[10px]">
        ...
        <div className="p-2">
          <h2 className="mb-2 px-5 text-xs font-semibold tracking-tight text-pink-800">
            Navegação
          </h2>
          <div className="">
            <Link
        ...
        <div className="">
          <h2 className="relative px-7 text-xs font-semibold tracking-tight text-pink-800">
            Conversas
          </h2>
          <div className="p-2">
